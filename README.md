...
⭐After you write in some information in the Weekly Events and To-Do's, you will be able to save it by using the save button in this same box.<br>
...
⭐Notes do not automatically save, so make sure to click on the save button!<br>
